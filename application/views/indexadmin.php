...
<body>
    ...
    <!--BEGIN CONTENT-->
        <div class="row">
            ...
            <p style="font-family:myFirstFont;font-size:26px;">REKAM MEDIK KEDOKTERAN GIGI-ADMIN</p>
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        Login Form
                    </div>
                    <div class="panel-body pan">
                        <form action="<?php echo base_url();?>welcome/loginadmin" class="form-horizontal" method="post">
